...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        self.epsilon = math.exp(-0.01*self.N)
        if testing ==True:
           print "Am here "
           self.epsilon=0
           self.alpha = 0
    ...
    def build_state(self):
        ...
        if self.learning == True:
            state= str([waypoint, inputs['left'], inputs['right'], inputs['oncoming'],inputs['light']])   
        return state
